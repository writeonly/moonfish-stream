...
object MoonfishService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The moonfish service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MoonfishService.
  */
trait MoonfishService extends Service {
  ...
  override final def descriptor = {
    ...
    named("moonfish")
      ...
      .withTopics(
        topic(MoonfishService.TOPIC_NAME, greetingsTopic)
